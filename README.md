...
The installer can also add official Superpowers and Codex Security, plus optional skills: frontend, Playwright, React, web-app testing (Anthropic), MCP builder (Anthropic), grill-me plan interrogation, and security best practices (OpenAI). Optional skills install only into the CLIs selected for this setup.
